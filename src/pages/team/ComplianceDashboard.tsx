  ...
  return (
    <div className="max-w-4xl">
      <div className="flex items-center gap-2">
        ...
        <h1 className="font-display text-title-1 font-bold text-neutral-900">Compliance</h1>
      </div>
      <p className="mt-1 text-callout text-neutral-600">Track RERA and statutory compliance records for {membership?.builderName}&rsquo;s projects.</p>
      ...
      {projects.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-6">{selected && <ComplianceTab projectId={selected} />}</div>
        </>
      )}
    </div>
  )
